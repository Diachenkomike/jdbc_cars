...
//            if (txtAddCarVIN.getText().length() < 11 || txtAddCarVIN.getText().length()>12) {
//                System.out.println(txtAddCarVIN.getText());
//                if (txtAddCarVIN.getText().contains("ua")){
//                    System.out.println("hui");
//                    lblVINError1.setOpacity(1);
//                    return;
//                }
//                else if(!Pattern.compile("[a-zа-я][0-9]{3}[a-zа-я]{2}[0-9]{2,3}"+"rus").matcher(txtAddCarVIN.getText()).matches()){
//                    System.out.println(txtAddCarVIN.getText());
...
//            }
            ...
            if (!Pattern.compile("[a-zа-я][0-9]{3}[a-zа-я]{2}[0-9]{2,3}rus").matcher(txtAddCarVIN.getText()).matches()) {
                //System.out.println(txtAddCarVIN.getText());
                lblVINError.setOpacity(1);
                return;
            }

//            if (Pattern.compile("[a-zа-я][0-9]{3}[a-zа-я]{2}[0-9]{2,3}ua").matcher(txtAddCarVIN.getText()).matches()) {
//                System.out.println(txtAddCarVIN.getText());
//                lblVINError1.setOpacity(1);
//                return;
//            }
    ...
    public void handleKeyPressedVIN() {
        lblVINCounter.textProperty().bind(txtAddCarVIN.textProperty().length().asString());
//        //setOpacity(1);
//        int l = txtAddCarVIN.getText().length();
//        System.out.println(l);
//        if (l < 13) {
//            lblVINCounter.setText(Integer.toString(l)+1);
//        } else {
//            lblVINCounter.setText(Integer.toString(l) + "/12");
//        }
